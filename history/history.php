    ...
    <nav class="header-nav">
        <div class="header-nav__container">
            ...
            <ul id="header-nav__list" class="header-nav__wrap">
                ...
                <li class="header-nav__item"><a class="header-nav__item-a header-nav__active" href="history/history.php">History</a></li>
...
<nav class="products-nav hyst-nav">
    <div class="products-nav__container">
        ...
        <ul id="products-nav__list" class="products-nav__right">
            <li class="products-nav__item hyst-nav__item"><a href="../history/1970s/index.php">1970's PHP</a></li>
...
<div class="content content__hystory">
    ...
    <div class="block-buttons hyst-block2">
        <div class="content__container">
            ...
            <div class="hyst-block2__wrap">
                <div class="hyst-block__wrap-2-3">
                    <a href="#" class="block-buttons__link hyst-block2__link6">
                        ...
                        <div class="block-buttons__link__txt hyst-block2__link__txt12">
                            <p class="block-buttons__link__txt1">
                                ENT01 remote electrode
                                probe for ENT-organs
                            </p>
                            <p class="block-buttons__link__txt2">
                                2016
                            </p>
    ...
    <div class="hyst-block-bigimg hyst-block3">
        <div class="content__container">
            <div class="hyst-block1__txt">
                <span class="hyst-block1__txt1">
                    ENS
    ...
    <div class="block-buttons hyst-block4">
        <div class="content__container">
    ...
    <div class="hyst-block-bigimg hyst-block5">
        <div class="content__container">
            <div class="hyst-block1__txt">
                <span class="hyst-block1__txt1">
                    SCENAR 035
    ...
    <div class="block-buttons hyst-block6">
        <div class="content__container">
    ...
    <div class="hyst-block-bigimg hyst-block7">
        <div class="content__container">
            <div class="hyst-block1__txt">
                <span class="hyst-block1__txt1">
                    ENS
    ...
    <div class="block-buttons hyst-block8">
        <div class="content__container">
    ...
    <div class="hyst-block-bigimg hyst-block9">
        <div class="content__container">
            <div class="hyst-block1__txt">
                <span class="hyst-block1__txt1">
                    ENS
    ...
    <div class="block-buttons hyst-block10">
        <div class="content__container">
    ...
    <div class="hyst-block-bigimg hyst-block11">
        <div class="content__container">
        </div>
    </div>
